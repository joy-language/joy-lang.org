<template>
  <main>
    ...
    <pre> "uc"  reverse  "xbe"  rest  concat  [dup dup * *]  DEF
    </pre>
    ...
    <pre> [cube]  first  [* * dup dup]  reverse  DEF1
    ...
    <pre> [current-item  1]   DEF2
    </pre>
    and to update it with, say an increment of 3, by
    <pre> current-item  3  +  []  cons  [current-item]  swoncat  DEF2
    </pre>
    ...
    <pre>first order use          second order use         third order use
      [dup *]       i
     [[dup *] i]    i         [dup *]    [i] i              
    ...
    <pre>    7   [[succ] [2 *] [dup *]]   [i]   map     ==&gt;     [8 14 49]
    </pre>
