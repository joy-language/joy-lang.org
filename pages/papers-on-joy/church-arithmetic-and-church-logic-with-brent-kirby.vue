<template>
  <article>
    ...
    <pre> Peano [[[[[C3] Csucc] [C2] Cadd] [C3] Cmul] Csucc] [C2] Cadd . 
    21
    ...
    <pre> Peano      Q3 Qsucc  Q2 Qadd  Q3 Qmul Qsucc Q2 Qadd i. 
    21
    ...
    <pre>About the construction of Csucc (which adds one to a church number),
    ...
    <pre> # The original definitions, commented away, are given for comparison. 
