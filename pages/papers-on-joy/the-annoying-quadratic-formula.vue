<template>
  <article>
    ...
    <p>
      <em>Abstract:</em> Complex expressions can be difficult to evaluate in Joy and
    ...
    <pre>         (quadratic-formula 2 -4 -6)  =&gt;  (3 . -1)
    </pre>
    Dybvig remarks (p 45):
    <pre>      ".. by employing two let expressions, the definition makes
    ...
    <pre>    1 2 3 [[pop dup *] [+] [2 *]]  [i] map  [] step
    </pre>
    ...
    <hl2>
      ...
      <pre>        [even]  [pop size 5 &gt;]  [       filter]  [       map]  ifte
