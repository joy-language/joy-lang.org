<template>
  <article>
    ...
    <p>
      Stevan Apter has adopted this principle in his web page <a href =
        "http://www.nsl.com/k/xy/xy.htm" > http: //www/nsl.com/k/xy/xy.htm</a>. There he
    ...
    ifte;
    j2f - reverse == [] swap[j2f - r] step[] swons. </pre>
    <p>
      The tests
    ...
    <p>
      This ends the output file <a href="flatjoy.out"> flatjoy.out </a> 
      from running the source file
      <a href="flatjoy.joy"> flatjoy.joy</a>.
      The definitions of the two translators j2f - forwards and j2f - backwards
      have been added in slightly modified form to the
      Joy library
      for symbolic manipulation, <a href="basic-libraries/symlib.joy"> symlib.joy</a>.
    </p>
    <p>
